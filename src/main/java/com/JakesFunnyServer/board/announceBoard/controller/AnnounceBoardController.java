...
public class AnnounceBoardController {
    ...
    public String boardWritePro(@ModelAttribute AnnounceBoardEntity announceBoard, Model model,
                                @RequestParam MultipartFile file) throws Exception {

        if(file != null || !file.isEmpty()) announceBoardService.write(announceBoard, file);
        else announceBoardService.write(announceBoard);
    ...
    public String boardList(Model model, @PageableDefault(page = 0, size = 10, sort = "id", direction = Sort.Direction.DESC)Pageable pageable,
        ...
        Page<AnnounceBoardEntity> list = null;
    ...
    public String boardUpdate(@PathVariable("id") Integer id, @ModelAttribute AnnounceBoardEntity announceBoard,
                              @RequestParam(name = "file") MultipartFile file) throws Exception{

        AnnounceBoardEntity boardTemp = announceBoardService.boardView(id);
